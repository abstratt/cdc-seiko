        ...
        <div class="col-sm-8">
            <div class="cart-table ">
                ...
                <div class="table-row" ng-repeat="orderItem in custom.edgeData.orderItems track by $index">
                    <div class="photo">
                        <ka-data grid=true size="'tiny'" slot="metadata.edges.orderItems.slots.productImage" slot-data="orderItem.productImage" object-id="orderItem.objectId">
                        </ka-data>
                    </div>
                    <div class="name">
